...
def main():
    ...
    # exploration method
    exp_method = 'add_decaying_random_noise' # plain, e_greedy, decaying_e_greedy, add_random_noise, add_decaying_random_noise
    ...
    for i in tqdm(range(num_episodes)):
        ...
        while not done:
            ...
            # update discounted Q with learning rate a
            Q[state, action] = (1 - a) * Q[state, action] \
                + a * (reward + gamma * np.max(Q[next_state, :]))
